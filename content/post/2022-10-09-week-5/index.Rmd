...
This week we learned about how advertising can affect the outcomes of elections, 
...
In the graph below, we can look at the relationship between the difference in the number of ads run per district in 2018 (number of democratic ads minus the number of republican ads) versus the major vote percentage for democratcs.
...
#   geom_point() +
#   geom_smooth(method = "lm") +
#   labs(x = "Percent of Total District Ad Cost (used for Democrat Ads)",
#        y = "Democrat Major Vote Percent",
#        title = "Difference in the Number of Ads Run vs. Democratic Vote Percentage by District in 2018",
#        subtitle = "Each point represents a district with sufficient data")
```
