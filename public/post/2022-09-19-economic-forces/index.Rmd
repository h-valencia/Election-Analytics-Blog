...
stargazer(econ1, econ2, econ3, econ4, type="text", covariate.labels = c("GDP Growth Percentage", "Disposable Income Percent Change", "Unemployment Rate","CPI Percent Change", "Constant"))
```
![Vote Share Regression Table.](Election-Analytics-Blog/content/post/2022-09-19-economic-forces/tab1.png)
...
```{r, eval=FALSE, warning=FALSE, message=FALSE}
stargazer(ss1, ss2, ss3, ss4, type="text", covariate.labels = c("GDP Growth Percentage", "Disposable Income Percent Change", "Unemployment Rate","CPI Percent Change", "Constant"))
```
![Seat Share Regression Table.](Election-Analytics-Blog/content/post/2022-09-19-economic-forces/tab2.png)
